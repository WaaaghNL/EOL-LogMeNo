...
echo "This is the management interface<br />";
    echo "<table border=1>";
    echo "<thead>";
    echo "<tr>";
    echo "<th>ID</th>";
    echo "<th>Tenant KEY</th>";
    echo "<th>Name</th>";
    echo "<th>JWT Key</th>";
    echo "<th>Time Zone</th>";
    echo "<th>maxage</th>";
    echo "<th>cache_logrows</th>";
    echo "<th>cache_recordings</th>";
    echo "<th>cache_days</th>";
    echo "<th>cache_storage</th>";
    echo "</tr>";
    echo "</thead>";
    echo "<tbody>";
    foreach ($tenants->listTenants() as $tenant) {
        echo "<td>" . $tenant['id'] . "</td>";
        echo "<td>" . $tenant['tenantkey'] . "</td>";
        echo "<td>" . $tenant['name'] . "</td>";
        echo "<td>" . (isset($tenant['ringcentral_jwt']) ? 'JWT KEY' : 'NO KEY') . "</td>";
        echo "<td>" . $tenant['timezone'] . "</td>";
        echo "<td>" . $tenant['maxage'] . "</td>";
        echo "<td>" . $tenant['cache_logrows'] . "</td>";
        echo "<td>" . $tenant['cache_recordings'] . "</td>";
        echo "<td>" . $tenant['cache_days'] . "</td>";
        echo "<td>" . $tenant['cache_storage'] . "</td>";
        echo "</tr>";
    }
    echo "</tbody>";
    echo "</table>";
